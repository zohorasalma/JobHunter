...
const Banner = () => {
    return (
        <div>
            <div className='bg-body-tertiary tagline-p'>
                <div className='container d-flex  justify-content-between flex-column-reverse  flex-md-row align-items-center p-5'>
                    ...
                    <div className='w-50 tagline-img'>
